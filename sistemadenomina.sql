...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-07-2022 a las 02:36:34
...
INSERT INTO `tb_empleado` (`id`, `nombre`, `horas_extra`, `aux_transp`, `salario`, `bono_dic`, `apellido`) VALUES
(1, 'IVAN', 50000, 'true', 8000000, 1200000, 'CASTRO'),
(2, 'SILVESTRE', 65000, 'true', 4125000, 500000, 'DANGOND'),
